...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 02, 2019 lúc 01:21 PM
...
(23, 16, 'Ngọc Quỳnh', '379N1/9 Nguyễn Văn Cừ, Ninh Kiều, Cần Thơ', '12345645', 1, 3, 'Admin', '2019-04-01 11:59:01', '2019-04-01 04:57:25', '2019-04-01 04:59:01', 1, 1, 2, 30000, 3630000),
(24, 19, 'Tạ Anh Hào', '56132', '12356', 1, NULL, NULL, NULL, '2019-04-01 07:44:19', '2019-04-01 07:44:20', 0, 1, 2, 30000, 5230000);
...
(29, 37, 20, 6, '2019-03-01', '2020-03-01'),
(35, 41, 30, 7, '2019-03-24', '2024-03-24'),
(36, 41, 25, 7, '2019-03-24', '2020-03-24'),
(37, 42, 44, 10, '2019-03-24', '2024-03-24'),
...
(53, 37, 9, 5, '2019-04-01', '2021-04-01');
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `ctdh_ma` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'mã chi tiết đơn hàng', AUTO_INCREMENT=33;
...
--
ALTER TABLE `danhgia`
  MODIFY `dg_ma` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Đánh giá mã', AUTO_INCREMENT=6;
...
--
ALTER TABLE `donhang`
  MODIFY `dh_ma` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'đơn hàng mã', AUTO_INCREMENT=25;
...
--
ALTER TABLE `khachhang`
  MODIFY `kh_ma` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'khách hàng mã', AUTO_INCREMENT=20;
...
--
ALTER TABLE `nhap`
  MODIFY `n_ma` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'mã', AUTO_INCREMENT=54;
