            ...
            <div class="col-sm-12">
                <div class="box" >
                    ...
                    <div class="box-body">
                       ...
                       <div style="padding: 0px 15px" class="table-responsive" ng-show="!isLoading && dsThanhtoan.length != 0">
                                ...
                                <tbody ng-if="dsThanhtoan.length > 0">
                                    <tr  ng-repeat="item in dsThanhtoan" id="tr_@{{item.tt_ma}}" ng-class="item.tt_ma == newMember_Data? 'bg-default':''">
                                        ...
                                        <td >
                                            ...
                                            <button ng-if="item.tt_ma != 1" class="btn btn-sm btn-flat btn-danger btn-flat btn-delete" ng-click="CreateEdit_show('delete', item.tt_ma)"><i class="fa fa-trash" ></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
