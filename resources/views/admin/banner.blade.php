            ...
            <div class="col-sm-12">
                <div class="box" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="" ng-show="!isLoading && dsBanner.length != 0">
                                ...
                                <tbody ng-if="dsBanner.length > 0">
                                    <tr  ng-repeat="item in dsBanner" id="tr_@{{item.bn_ma}}" ng-class="item.bn_ma == newMember_Data? 'bg-default':''">
                                        ...
                                        <td >
                                            ...
                                            <button class="btn btn-sm btn-flat bg-maroon btn-delete" ng-click="CreateEdit_show('delete', item.bn_ma)"><i class="fa fa-trash" ></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <form name="frmCreatEdit" id="frmCreatEdit" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group"> 
                                <button type="submit" id="addbanner" class="btn bg-maroon btn-block" >@{{dialogButton}}</button>
                            </div>
                        </div>
                    </div>
                </form>
