                                ...
                                <tbody>
                                    <tr  ng-repeat="item in dsNhanvien" id="tr_@{{item.nv_ma}}" ng-class="item.nv_ma == newMember_Data? 'bg-default':''" ng-if="item.nv_hoTen != 'Admin'">
                                        ...
                                        <td >
                                            ...
                                            <button  ng-if="{{Session::get('admin_id')}} != item.nv_ma" class="btn btn-sm btn-flat bg-maroon btn-delete" ng-click="CreateEdit_show('delete', item.nv_ma)"><i class="fa fa-trash" ></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
