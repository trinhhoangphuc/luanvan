            ...
            <div class="col-sm-12">
                <div class="box" >
                    ...
                    <div class="box-body">
                       ...
                       <div class="table-responsive" ng-show="!isLoading && dsVanchuyen.length != 0" style="padding: 0px 15px">
                                ...
                                <tbody ng-if="dsVanchuyen.length > 0">
                                    <tr  ng-repeat="item in dsVanchuyen" id="tr_@{{item.vc_ma}}" ng-class="item.vc_ma == newMember_Data? 'bg-default':''">
                                        ...
                                        <td >
                                            ...
                                            <button class="btn btn-sm btn-flat btn-danger btn-flat btn-delete" ng-click="CreateEdit_show('delete', item.vc_ma)"><i class="fa fa-trash" ></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                       <div style="padding: 0px 15px" class="table-responsive" ng-show="!isLoading && dsVanchuyen.length == 0 ">
                ...
                <form name="frmCreatEdit" id="frmCreatEdit">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group"> 
                                <button type="submit" class="btn btn-danger btn-flat btn-block"  ng-click="CreateEdit_save()">@{{dialogButton}}</button>
                            </div>
                        </div>
                    </div>
                </form>
