            ...
            <div class="col-sm-12">
                <div class="box" >
                    ...
                    <div class="box-body">
                        ...
                        <div class="table-responsive" style="padding: 0px 15px" ng-show="!isLoading && dsHang.length != 0">
                                ...
                                <tbody ng-if="dsHang.length > 0">
                                    <tr  ng-repeat="item in dsHang" id="tr_@{{item.h_ma}}" ng-class="item.h_ma == newMember_Data? 'bg-default':''">
                                        ...
                                        <td >
                                            ...
                                            <button class="btn btn-sm btn-flat btn-danger btn-flat btn-delete" ng-click="CreateEdit_show('delete', item.h_ma)"><i class="fa fa-trash" ></i></button>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
